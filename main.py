...
def genAnswers(filename,chatbot, description):
    ...
    for i,elem in enumerate(tqdm(dictlist)):
        ...
        # print(elem["title"])
        # print(elem["retrieved"])
        # print(elem["question"])
        # print(elem["answer"])
        # print("##########")
        # print(elem["n_input_tokens"])
        # print(elem["n_output_tokens"])
...
if __name__ == "__main__":
    ...
    scrapper.scrapeAndSaveArticles(n=100) #this outputs A_r
    # scrapper.filterforDate(foldername+ "/A_r.pkl") #this outputs A_d
    # scrapper.genQs(foldername+ "/A_d_2.pkl") #add qs to file
    # scrapper.genQs(foldername+ "/A_r_first300.pkl") #add qs to file
